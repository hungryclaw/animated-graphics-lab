...
export type AglWorkflowStage = 'input_received' | 'article_prepared' | 'directives_found' | 'spots_planned' | 'drafts_queued' | 'drafts_generated' | 'drafts_validated' | 'renders_queued' | 'rendered' | 'exported' | 'completed' | 'failed';
export type AglVisualStatus = 'planned' | 'accepted' | 'preview_generating' | 'preview_ready' | 'preview_failed' | 'render_queued' | 'rendering' | 'rendered' | 'render_failed' | 'embedded' | 'failed';
