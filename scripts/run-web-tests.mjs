...
const defaultTests = ['src/lib/resume-state.test.ts', 'src/lib/graphic-directives.test.ts', 'src/lib/article-export.test.ts', 'src/lib/gif-downloads.test.ts', 'src/lib/current-result-view.test.ts', 'src/data/demo-fixtures.test.ts'];
